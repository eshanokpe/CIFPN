                                ...
                                <tbody>
                                    @forelse ($consultants as $index => $consultant)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a class="btn btn-primary " style="margin-right: 5px;" href="{{ route('admin.consultant.show', encrypt($consultant->id)) }}">Edit</a>
                                                    <a class="btn btn-danger" href="{{ route('admin.consultant.destroy', encrypt($consultant->id) )  }}" onclick="return confirm('Are you sure you want to delete this Consultant?');">Delete</a>
                                                </div>
