        ...
        <div class="container-fluid">
            <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
                <div class="me-auto d-lg-block d-block">
                    <h2 class="text-black font-w600">Industries</h2>
                    <p class="mb-0">Welcome to  {{ $contactUs->company_name}} backend</p>
                </div>
                <a href="{{route('admin.industries.index')}}" class="btn btn-primary rounded light">View Industries</a>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <form method="POST"  action="{{ route('admin.industries.update', $industries->id ) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-3 row align-items-center">
                                        <label class="col-sm-3 col-form-label form-label">Title</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Title" name="title" id="title" value="{{ $industries->title }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="">
                                                <textarea name="content" id="ckeditor" class="form-control" required>{{ $industries->content }}</textarea>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            @enderror
                                            <img src="{{ asset($industries->image) }}" alt="{{ $industries->title }}" class="img-thumbnail mt-2" width="200">
