    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 breadcrumb-1">
                ...
                <h1 class="title">{{$industriesItem->title }}</h1>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="bread-tag">
                    <a href="{{ route('home') }}">Home</a>
                    <span> / </span>
                    <a href="#" class="active">Industries Details</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                ...
                <div class="service-detials-step-1">
                    <div class="thumbnail">
                        <img src="{{ asset($industriesItem->image)}}" class="w-100" style="object-fit: cover; width: 100%; height: 600px;" alt="business-area">
                    </div> 
                    <h4 class="title">{{$industriesItem->title }} </h4>
                    <p class="disc" >
                        {!! $industriesItem->content !!} 
                    </p>
            ...
            <div class="col-xl-4 col-md-12 col-sm-12 col-12 mt_lg--60 pl--50 pl_md--0 pl-lg-controler pl_sm--0">
                ...
                <div class="rts-single-wized Categories service">
                    ...
                    <div class="wized-body">
                        @forelse ($relatedIndustries as $relatedIndustries)
                             <!-- single categoris -->
                            <ul class="single-categories">
                                <li><a href="{{ route('industries.detail', ['slug' => $relatedIndustries->slug] ) }}">{{ $relatedIndustries->title }} <i class="far fa-long-arrow-right"></i></a></li>
                            </ul>
