                    ...
                    <div class="wized-body">
                        @forelse ($relatedSolutions as $relatedSolution)
                            ...
                            <ul class="single-categories">
                                <li><a href="{{ route('solutions.detail', encrypt($relatedSolution->id)) }}">{{ $relatedSolution->title }} <i class="far fa-long-arrow-right"></i></a></li>
                            </ul>
                ...
                <div class="rts-single-wized contact service">
                    ...
                    <div class="wized-body">
                        <h5 class="title">Need Help? We Are Here
                            To Help You</h5>
                        <a class="rts-btn btn-primary" href="{{ route('contactus') }}">Contact Us</a>
                    </div>
                </div>
                <!-- single wizered End -->
            </div>
